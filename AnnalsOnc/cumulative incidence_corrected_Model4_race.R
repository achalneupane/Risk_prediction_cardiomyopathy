...
# Load data based on Model 4 (clinical + age at baseline + htn + race)
final_model = read_xlsx('figure_2_all_new_13.xlsx', sheet = "Model_4")
...
p3 = ggcuminc(m3, outcome = c("1"),linetype_aes = TRUE) +
  ...
  custom_theme
p3
ggsave("cif_model_sjlife_model4_race.png", plot=p3, dpi=300, width=7.5, height=7)
# CCSS
# df3 = subset(df, source=="ccss")
...
p4 = ggcuminc(m4, outcome = c("1"),linetype_aes = TRUE) +
  ...
  custom_theme 
p4
ggsave("cif_model_ccss_model4_race.png", plot=p4, dpi=300, width=7.5, height=7)